	...
	return (
		<>
			<div className="absolute inset-0">
				...
				<div ref={contentRef}
				     className="absolute h-max left-0 right-0 top-0 pt-20 sm:pt-24 md:top-1/3 md:right-1/2 md:pt-0 flex flex-col gap-3 sm:gap-4 justify-start px-6 sm:px-8 md:px-16 bg-linear-to-b from-black/70 via-black/30 to-transparent md:bg-none select-none">
					<h3
