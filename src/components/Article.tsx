		...
		<>
			...
			>
				...
				<div className="absolute inset-0 p-6 sm:p-8 z-10">
					...
					<div className="w-full h-20 flex flex-col justify-between absolute left-0 right-0 bottom-0 z-10 bg-top  box-border p-4" style={{backgroundImage: `url(${item_msg})`}}>
